...
/* harmony default export */ var timevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    mapping: function mapping() {
      return Object(date_util_["getTimeMapping"])(this.format, this.date);
    },
    ...
    parsedSteps: function parsedSteps() {
      return this.steps ? Object(date_util_["parseDate"])(this.steps, this.format) : null;
    }
  },
  methods: {
    transform: function transform(date) {
      return Object(date_util_["transformTime"])(date, this.format);
    },
    ...
    handleConfirm: function handleConfirm() {
      ...
      if (first) return;
      var date = Object(date_util_["limitTimeRange"])(this.date, this.selectableRange, this.format);
...
var external_normalize_wheel_ = __webpack_require__(32);
  ...
  methods: {
    ...
    getModifedDate: function getModifedDate(type, value) {
      ...
      var modTime = function modTime(hours, mins, secs, millis) {
        return Object(date_util_["modifyTime"])(_this6.date, hours, mins, secs, Math.round(millis * 1000 / _this6.maxMillisecs));
      };
      switch (type) {
        case 'hour':
    ...
    scrollDown: function scrollDown(step) {
      ...
      var getNextDate = function getNextDate(type) {
        ...
        return result.getDate() === day ? result : step > 0 ? Object(date_util_["parseDate"])('23:59:59.999', 'HH:mm:ss:SSS') : Object(date_util_["parseDate"])('0', 'H');
      };
      ...
      if (step > 0 && now.val < prev || step < 0 && now.val > prev || prev === now.val) {
        var nextDate = Object(date_util_["limitTimeRange"])(getNextDate(type), this.selectableRange, this.format);
...
/* harmony default export */ var time_rangevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    MIN_TIME: function MIN_TIME() {
      return Object(date_util_["limitTimeRange"])(Object(date_util_["parseDate"])('00:00', 'HH:mm'), this.selectableRange, this.format);
    },
    MAX_TIME: function MAX_TIME() {
      return Object(date_util_["limitTimeRange"])(Object(date_util_["parseDate"])('23:59:59.999', 'HH:mm:ss.SSS'), this.selectableRange, this.format);
    },
    minMapping: function minMapping() {
      return Object(date_util_["getTimeMapping"])(this.format, this.minDate);
    },
    maxMapping: function maxMapping() {
      return Object(date_util_["getTimeMapping"])(this.format, this.maxDate);
    },
    columns: function columns() {
      var val = {};
  ...
  methods: {
    ...
    handleConfirm: function handleConfirm() {
      ...
      this.minDate = Object(date_util_["limitTimeRange"])(this.minDate, this.minSelectableRange, this.format);
      this.maxDate = Object(date_util_["limitTimeRange"])(this.maxDate, this.maxSelectableRange, this.format);
    ...
    isValidValue: function isValidValue(date) {
      return date.length === 2 && Object(date_util_["timeWithinRange"])(date[0], this.minSelectableRange, this.format) && Object(date_util_["timeWithinRange"])(date[1], this.maxSelectableRange, this.format);
    },
    handleKeydown: function handleKeydown(event) {
      var keyCode = event.keyCode;
      var mapping = { 38: -1, 40: 1, 37: -1, 39: 1 };
