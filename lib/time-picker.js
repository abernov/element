...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_08efbb1d_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_range_vue__ = __webpack_require__(251);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_08efbb1d_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_range_vue__["a" /* default */],
...
exports.default = {
  ...
  computed: {
    ...
    MIN_TIME: function MIN_TIME() {
      return this.transform((0, _util.parseDate)('00:00:00.000', 'HH:mm:ss.SSS'));
    },
    MAX_TIME: function MAX_TIME() {
      return this.transform((0, _util.parseDate)('23:59:59.999', 'HH:mm:ss.SSS'));
    },
    mapping: function mapping() {
      return (0, _util.getTimeMapping)(this.format);
    },
  ...
  watch: {
    ...
    visible: function visible(val) {
      ...
      if (val) {
        this.oldValue = this.value;
        this.$nextTick(function () {
          return _this.$refs.minSpinner.emitSelectRange(_this.mapping.order[0]);
        });
      }
    }
  },
  ...
  methods: {
    ...
    minTimeOfDay: function minTimeOfDay(date) {
      return (0, _util.modifyDate)(this.MIN_TIME, date.getFullYear(), date.getMonth(), date.getDate());
    },
    maxTimeOfDay: function maxTimeOfDay(date) {
      return (0, _util.modifyDate)(this.MAX_TIME, date.getFullYear(), date.getMonth(), date.getDate());
    },
    ...
    changeSelectionRange: function changeSelectionRange(step) {
      ...
      var getList = function getList(delta) {
        return order.map(function (type) {
          return _this2.mapping[type][0] + delta;
        });
      };

      var list = getList(0).concat(getList(this.offset));
      var index = list.indexOf(this.selectionRange[0]);
    ...
    isValidValue: function isValidValue(date) {
      return Array.isArray(date) && (0, _util.timeWithinRange)(this.minDate, this.$refs.minSpinner.selectableRange, this.format) && (0, _util.timeWithinRange)(this.maxDate, this.$refs.maxSpinner.selectableRange, this.format);
    },
    handleKeydown: function handleKeydown(event) {
      var keyCode = event.keyCode;
      var mapping = { 38: -1, 40: 1, 37: -1, 39: 1 };
