...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_time_range_vue__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7c8f74db_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_range_vue__ = __webpack_require__(251);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7c8f74db_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_range_vue__["a" /* default */],
...
exports.default = {
  ...
  computed: {
    ...
    MIN_TIME: function MIN_TIME() {
      return (0, _util.limitTimeRange)((0, _util.parseDate)('00:00', 'HH:mm'), this.selectableRange, this.format);
    },
    MAX_TIME: function MAX_TIME() {
      return (0, _util.limitTimeRange)((0, _util.parseDate)('23:59:59.999', 'HH:mm:ss.SSS'), this.selectableRange, this.format);
    },
    minMapping: function minMapping() {
      return (0, _util.getTimeMapping)(this.format, this.minDate);
    },
    maxMapping: function maxMapping() {
      return (0, _util.getTimeMapping)(this.format, this.maxDate);
    },
    columns: function columns() {
      var val = {};
  ...
  methods: {
    ...
    handleConfirm: function handleConfirm() {
      ...
      this.minDate = (0, _util.limitTimeRange)(this.minDate, this.minSelectableRange, this.format);
      this.maxDate = (0, _util.limitTimeRange)(this.maxDate, this.maxSelectableRange, this.format);
    ...
    isValidValue: function isValidValue(date) {
      return date.length === 2 && (0, _util.timeWithinRange)(date[0], this.minSelectableRange, this.format) && (0, _util.timeWithinRange)(date[1], this.maxSelectableRange, this.format);
    },
    handleKeydown: function handleKeydown(event) {
      var keyCode = event.keyCode;
      var mapping = { 38: -1, 40: 1, 37: -1, 39: 1 };
