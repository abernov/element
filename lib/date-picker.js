...
var year_tablevue_type_script_lang_js_datesInYear = function datesInYear(year) {
  var numOfDays = Object(util["g" /* getDayCountOfYear */])(year);
  var firstDay = new Date(year, 0, 1);
  return Object(util["y" /* range */])(numOfDays).map(function (n) {
    return Object(util["r" /* nextDate */])(firstDay, n);
  });
};
  ...
  props: {
    ...
    defaultValue: {
      validator: function validator(val) {
        ...
        return val === null || val instanceof Date && Object(util["l" /* isDate */])(val);
      }
    },
    date: {}
  },
...
var month_tablevue_type_script_lang_js_datesInMonth = function datesInMonth(year, month) {
  var numOfDays = Object(util["f" /* getDayCountOfMonth */])(year, month);
...
var date_tablevue_type_script_lang_js_getDateTimestamp = function getDateTimestamp(time) {
  if (typeof time === 'number' || typeof time === 'string') {
    return Object(util["b" /* clearTime */])(new Date(time)).getTime();
  } else if (time instanceof Date) {
    return Object(util["b" /* clearTime */])(time).getTime();
  } else {
    return NaN;
  }
};
...
/* harmony default export */ var date_tablevue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    defaultValue: {
      validator: function validator(val) {
        ...
        return val === null || Object(util["l" /* isDate */])(val) || Array.isArray(val) && val.every(util["l" /* isDate */]);
      }
    },
  ...
  computed: {
    ...
    startDate: function startDate() {
      return Object(util["i" /* getStartDateOfMonth */])(this.year, this.month);
    },
    rows: function rows() {
      var _this = this;
      ...
      var day = Object(util["h" /* getFirstDayOfMonth */])(date); // day of first day
      var dateCountOfMonth = Object(util["f" /* getDayCountOfMonth */])(date.getFullYear(), date.getMonth());
      var dateCountOfLastMonth = Object(util["f" /* getDayCountOfMonth */])(date.getFullYear(), date.getMonth() === 0 ? 11 : date.getMonth() - 1);
      ...
      for (var i = 0; i < 6; i++) {
        ...
        if (this.showWeekNumber) {
          if (!row[0]) {
            row[0] = { type: 'week', text: Object(util["k" /* getWeekNumber */])(Object(util["r" /* nextDate */])(startDate, i * 7 + 1)) };
          }
        }
        ...
        var _loop = function _loop(j) {
          ...
          var index = i * 7 + j;
          var time = Object(util["r" /* nextDate */])(startDate, index - offset).getTime();
  ...
  methods: {
    ...
    getDateOfCell: function getDateOfCell(row, column) {
      ...
      return Object(util["r" /* nextDate */])(this.startDate, offsetFromStart);
    },
    isWeekActive: function isWeekActive(cell) {
      ...
      if (Object(util["l" /* isDate */])(this.value)) {
        ...
        var weekDate = Object(util["v" /* prevDate */])(this.value, dayOffset);
    ...
    markRange: function markRange(minDate, maxDate) {
      ...
      for (var i = 0, k = rows.length; i < k; i++) {
        ...
        for (var j = 0, l = row.length; j < l; j++) {
          ...
          var time = Object(util["r" /* nextDate */])(startDate, index - this.offsetDay).getTime();
    ...
    handleClick: function handleClick(event) {
      ...
      if (this.selectionMode === 'range') {
        ...
        var weekNumber = Object(util["k" /* getWeekNumber */])(newDate);
...
/* harmony default export */ var datevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    emit: function emit(value) {
      ...
      if (!value) {
        ...
        var dates = value.map(function (date) {
          return _this4.showTime ? Object(util["A" /* transformTime */])(date, _this4.timeFormat) : Object(util["b" /* clearTime */])(date);
        });
        this.$emit.apply(this, ['pick', dates].concat(args));
      } else {
        this.$emit.apply(this, ['pick', this.showTime ? Object(util["A" /* transformTime */])(value, this.timeFormat) : Object(util["b" /* clearTime */])(value)].concat(args));
      }
    ...
    nextMonth: function nextMonth() {
      this.date = Object(util["s" /* nextMonth */])(this.date);
    },
    ...
    nextYear: function nextYear() {
      if (this.currentView === 'year') {
        this.date = Object(util["t" /* nextYear */])(this.date, 10);
      } else {
        this.date = Object(util["t" /* nextYear */])(this.date);
      }
    },
    ...
    handleTimePick: function handleTimePick(value, visible, first) {
      if (Object(util["l" /* isDate */])(value)) {
        var newDate = this.value ? Object(util["p" /* modifyTime */])(this.value, value.getHours(), value.getMinutes(), value.getSeconds()) : Object(util["q" /* modifyWithTimeString */])(this.getDefaultValue(), this.defaultTime);
        this.date = newDate;
    ...
    handleMonthPick: function handleMonthPick(month) {
      if (this.selectionMode === 'month') {
        this.date = Object(util["o" /* modifyDate */])(this.date, this.year, month, 1);
        this.emit(this.date);
      } else {
    ...
    handleDatePick: function handleDatePick(value) {
      if (this.selectionMode === 'day') {
        var newDate = this.value ? Object(util["o" /* modifyDate */])(this.value, value.getFullYear(), value.getMonth(), value.getDate()) : Object(util["q" /* modifyWithTimeString */])(value, this.defaultTime);
        // change default time while out of selectableRange
        if (!this.checkDateWithinRange(newDate)) {
          newDate = Object(util["o" /* modifyDate */])(this.selectableRange[0][0], value.getFullYear(), value.getMonth(), value.getDate());
        }
        this.date = newDate;
    ...
    handleYearPick: function handleYearPick(year) {
      if (this.selectionMode === 'year') {
        this.date = Object(util["o" /* modifyDate */])(this.date, year, 0, 1);
        this.emit(this.date);
      } else {
    ...
    confirm: function confirm() {
      if (this.selectionMode === 'dates') {
        ...
        var value = this.value ? this.value : Object(util["q" /* modifyWithTimeString */])(this.getDefaultValue(), this.defaultTime);
    ...
    handleVisibleTimeChange: function handleVisibleTimeChange(value) {
      var time = Object(util["u" /* parseDate */])(value, this.timeFormat);
      if (time && this.checkDateWithinRange(time)) {
        this.date = Object(util["o" /* modifyDate */])(time, this.year, this.month, this.monthDate);
        this.userInputTime = null;
    ...
    handleVisibleDateChange: function handleVisibleDateChange(value) {
      var date = Object(util["u" /* parseDate */])(value, this.dateFormat);
      if (date) {
        if (typeof this.disabledDate === 'function' && this.disabledDate(date)) {
          return;
        }
        this.date = Object(util["p" /* modifyTime */])(date, this.date.getHours(), this.date.getMinutes(), this.date.getSeconds());
        this.userInputDate = null;
        this.resetView();
        this.emit(this.date, true);
      }
    ...
    checkDateWithinRange: function checkDateWithinRange(date) {
      return this.selectableRange.length > 0 ? Object(util["z" /* timeWithinRange */])(date, this.selectableRange, this.format || 'HH:mm:ss') : true;
    }
  },
  ...
  computed: {
    ...
    week: function week() {
      return Object(util["k" /* getWeekNumber */])(this.date);
    },
    ...
    visibleTime: function visibleTime() {
      if (this.userInputTime !== null) {
        ...
        return Object(util["e" /* formatDate */])(this.value || this.defaultValue, this.timeFormat);
      }
    },
    visibleDate: function visibleDate() {
      if (this.userInputDate !== null) {
        ...
        return Object(util["e" /* formatDate */])(this.value || this.defaultValue, this.dateFormat);
      }
    },
    ...
    timeFormat: function timeFormat() {
      if (this.format) {
        return Object(util["d" /* extractTimeFormat */])(this.format);
      } else {
        return 'HH:mm:ss';
      }
    },
    dateFormat: function dateFormat() {
      if (this.format) {
        return Object(util["c" /* extractDateFormat */])(this.format);
      } else {
        return 'yyyy-MM-dd';
      }
    }
...
/* harmony default export */ var date_rangevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    minVisibleDate: function minVisibleDate() {
      ...
      if (this.minDate) return Object(util["e" /* formatDate */])(this.minDate, this.dateFormat);
      return '';
    },
    maxVisibleDate: function maxVisibleDate() {
      if (this.dateUserInput.max !== null) return this.dateUserInput.max;
      if (this.maxDate || this.minDate) return Object(util["e" /* formatDate */])(this.maxDate || this.minDate, this.dateFormat);
      return '';
    },
    minVisibleTime: function minVisibleTime() {
      if (this.timeUserInput.min !== null) return this.timeUserInput.min;
      if (this.minDate) return Object(util["e" /* formatDate */])(this.minDate, this.timeFormat);
      return '';
    },
    maxVisibleTime: function maxVisibleTime() {
      if (this.timeUserInput.max !== null) return this.timeUserInput.max;
      if (this.maxDate || this.minDate) return Object(util["e" /* formatDate */])(this.maxDate || this.minDate, this.timeFormat);
      return '';
    },
    timeFormat: function timeFormat() {
      if (this.format) {
  ...
  data: function data() {
    return {
      ...
      maxDate: '',
      leftDate: new Date(),
      rightDate: Object(util["s" /* nextMonth */])(new Date()),
      rangeState: {
        endDate: null,
        selecting: false,
        row: null,
  ...
  watch: {
    minDate: function minDate(val) {
      ...
      this.$nextTick(function () {
        if (_this.$refs.maxTimePicker && _this.maxDate && _this.maxDate < _this.minDate) {
          var format = 'HH:mm:ss';
          _this.$refs.maxTimePicker.selectableRange = [[Object(util["u" /* parseDate */])(Object(util["e" /* formatDate */])(_this.minDate, format), format), Object(util["u" /* parseDate */])('23:59:59', format)]];
        }
      });
    ...
    value: function value(newVal) {
      if (!newVal) {
        ...
        this.minDate = Object(util["l" /* isDate */])(newVal[0]) ? new Date(newVal[0]) : null;
        this.maxDate = Object(util["l" /* isDate */])(newVal[1]) ? new Date(newVal[1]) : null;
        if (this.minDate) {
          ...
          if (this.unlinkPanels && this.maxDate) {
            ...
            this.rightDate = minDateYear === maxDateYear && minDateMonth === maxDateMonth ? Object(util["s" /* nextMonth */])(this.maxDate) : this.maxDate;
          } else {
            this.rightDate = Object(util["s" /* nextMonth */])(this.leftDate);
          }
        } else {
    ...
    defaultValue: function defaultValue(val) {
      if (!Array.isArray(this.value)) {
        ...
        this.leftDate = left;
        this.rightDate = val && val[1] && this.unlinkPanels ? right : Object(util["s" /* nextMonth */])(this.leftDate);
      }
    }
  },
  ...
  methods: {
    ...
    handleDateInput: function handleDateInput(value, type) {
      ...
      var parsedValue = Object(util["u" /* parseDate */])(value, this.dateFormat);
      ...
      if (parsedValue) {
        ...
        if (type === 'min') {
          this.minDate = Object(util["o" /* modifyDate */])(this.minDate || new Date(), parsedValue.getFullYear(), parsedValue.getMonth(), parsedValue.getDate());
          this.leftDate = new Date(parsedValue);
          if (!this.unlinkPanels) {
            this.rightDate = Object(util["s" /* nextMonth */])(this.leftDate);
          }
        } else {
          this.maxDate = Object(util["o" /* modifyDate */])(this.maxDate || new Date(), parsedValue.getFullYear(), parsedValue.getMonth(), parsedValue.getDate());
    ...
    handleDateChange: function handleDateChange(value, type) {
      ...
      if (parsedValue) {
        if (type === 'min') {
          this.minDate = Object(util["o" /* modifyDate */])(this.minDate, parsedValue.getFullYear(), parsedValue.getMonth(), parsedValue.getDate());
          if (this.minDate > this.maxDate) {
            this.maxDate = this.minDate;
          }
        } else {
          this.maxDate = Object(util["o" /* modifyDate */])(this.maxDate, parsedValue.getFullYear(), parsedValue.getMonth(), parsedValue.getDate());
    ...
    handleTimeInput: function handleTimeInput(value, type) {
      ...
      var parsedValue = Object(util["u" /* parseDate */])(value, this.timeFormat);

      if (parsedValue) {
        if (type === 'min') {
          this.minDate = Object(util["p" /* modifyTime */])(this.minDate, parsedValue.getHours(), parsedValue.getMinutes(), parsedValue.getSeconds());
          this.$nextTick(function (_) {
            return _this4.$refs.minTimePicker.adjustSpinners();
          });
        } else {
          this.maxDate = Object(util["p" /* modifyTime */])(this.maxDate, parsedValue.getHours(), parsedValue.getMinutes(), parsedValue.getSeconds());
          this.$nextTick(function (_) {
    ...
    handleRangePick: function handleRangePick(val) {
      ...
      var minDate = Object(util["q" /* modifyWithTimeString */])(val.minDate, defaultTime[0]);
      var maxDate = Object(util["q" /* modifyWithTimeString */])(val.maxDate, defaultTime[1]);
    ...
    handleMinTimePick: function handleMinTimePick(value, visible, first) {
      ...
      if (value) {
        this.minDate = Object(util["p" /* modifyTime */])(this.minDate, value.getHours(), value.getMinutes(), value.getSeconds());
      }
    ...
    handleMaxTimePick: function handleMaxTimePick(value, visible, first) {
      if (this.maxDate && value) {
        this.maxDate = Object(util["p" /* modifyTime */])(this.maxDate, value.getHours(), value.getMinutes(), value.getSeconds());
      }
    ...
    rightNextYear: function rightNextYear() {
      if (!this.unlinkPanels) {
        this.leftDate = Object(util["t" /* nextYear */])(this.leftDate);
        this.rightDate = Object(util["s" /* nextMonth */])(this.leftDate);
      } else {
        this.rightDate = Object(util["t" /* nextYear */])(this.rightDate);
      }
    },
    rightNextMonth: function rightNextMonth() {
      if (!this.unlinkPanels) {
        this.leftDate = Object(util["s" /* nextMonth */])(this.leftDate);
        this.rightDate = Object(util["s" /* nextMonth */])(this.leftDate);
      } else {
        this.rightDate = Object(util["s" /* nextMonth */])(this.rightDate);
      }
    },
    ...
    isValidValue: function isValidValue(value) {
      return Array.isArray(value) && value && value[0] && value[1] && Object(util["l" /* isDate */])(value[0]) && Object(util["l" /* isDate */])(value[1]) && value[0].getTime() <= value[1].getTime() && (typeof this.disabledDate === 'function' ? !this.disabledDate(value[0]) && !this.disabledDate(value[1]) : true);
    },
    resetView: function resetView() {
      // NOTE: this is a hack to reset {min, max}Date on picker open.
      // TODO: correct way of doing so is to refactor {min, max}Date to be dependent on value and internal selection state
      //       an alternative would be resetView whenever picker becomes visible, should also investigate date-panel's resetView
      this.minDate = this.value && Object(util["l" /* isDate */])(this.value[0]) ? new Date(this.value[0]) : null;
      this.maxDate = this.value && Object(util["l" /* isDate */])(this.value[0]) ? new Date(this.value[1]) : null;
    }
  },
