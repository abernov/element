...
var transformTime = exports.transformTime = function transformTime(date) {
  ...
  var time = parseDate(formatDate(date, format), format);
...
exports.default = {
  ...
  computed: {
    ...
    arrowList: function arrowList() {
      ...
      this.mapping.order.forEach(function (type) {
        var val = _this[type];
        result[type] = [val > 0 ? val - 1 : undefined, val, val < _this.maxOfType(type) - 1 ? val + 1 : undefined];
      });
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      !_this3.arrowControl && _this3.bindScrollEvent();
    });
  },
  ...
  methods: {
    ...
    modifyDateField: function modifyDateField(type, value) {
      ...
      var modTime = function modTime(hours, mins, secs, millis) {
        var date = new Date(_this4.date.getTime());
        date.setMilliseconds(Math.round(millis * 1000 / _this4.maxMillisecs));
        _this4.$emit('change', (0, _util.modifyTime)(date, hours, mins, secs));
      };
      ...
      var getVal = function getVal(rDate, idx) {
        ...
        switch (type) {
          case 'hour':
            return r_h;
          case 'minute':
            return r_h === _this5.hour ? r_m : idx ? 59 : 0;
          case 'second':
            return r_h === _this5.hour && r_m === _this5.minute ? r_s : idx ? 59 : 0;
          case 'millisecond':
            var r_ms = _this5.getConvertedMs(rDate.getMilliseconds());
            var val = r_h === _this5.hour && r_m === _this5.minute && r_s === _this5.second ? r_ms : idx ? _this5.getConvertedMs(999) : 0;
            return val;
        };
      };
    ...
    bindScrollEvent: function bindScrollEvent() {
      ...
      this.mapping.order.forEach(function (type, idx) {
        _this6.el[type].wrap.onscroll = function (e) {
          // TODO: scroll is emitted when set scrollTop programatically
          // should find better solutions in the future!
          _this6.handleScroll(type, e);
        };
      });
    },
    ...
    adjustSpinners: function adjustSpinners() {
      ...
      this.mapping.order.forEach(function (type) {
        _this7.adjustSpinner(type, _this7[type]);
      });
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55b1d2bc_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_vue__ = __webpack_require__(44);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55b1d2bc_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_82144a30_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_spinner_vue__ = __webpack_require__(43);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_82144a30_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_time_spinner_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
