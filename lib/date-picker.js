    ...
    emit: function emit(value) {
      ...
      if (!value) {
        ...
        var dates = value.map(function (date) {
          return _this4.showTime ? Object(date_util_["transformTime"])(date, _this4.timeFormat) : Object(date_util_["clearTime"])(date);
        });
        this.$emit.apply(this, ['pick', dates].concat(args));
      } else {
        this.$emit.apply(this, ['pick', this.showTime ? Object(date_util_["transformTime"])(value, this.timeFormat) : Object(date_util_["clearTime"])(value)].concat(args));
      }
